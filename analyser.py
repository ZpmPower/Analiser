...
def num_keyword(title):
    meta = str('BY FRAN BERKMAN NOV 20, 2013')
...
labelDay.place(x=163,y=230)
comboDay = ttk.Combobox(root)
comboDay['values']= ("No","Yes")
comboDay.place(x=180,y=250)
comboDay.current(0)
#
resultBtn = Button(text="Activate", command=lambda: resultBtn_click())
resultBtn.place(x=222, y=275) 
#
